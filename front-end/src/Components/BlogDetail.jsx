  ...
  return (
   <>
    ...
    <div style={{width:'90%' ,margin :'auto' , borderRadius:' 15px' , border: '2px solid black' , marginTop :'20px'}}>
      ...
      <div style={{display:'flex' , flexDirection :'column' , rowGap: '20px' , boxShadow: 'rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset' , width :'90%', margin :'auto' , marginTop: '100px' , padding:'20px'}} id='update' > <h2>Update Blog</h2>
